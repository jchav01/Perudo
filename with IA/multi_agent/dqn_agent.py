# -*- coding: utf-8 -*-
"""
Created on Sat Jun 15 19:35:25 2024
...
class DQNAgent:
    def __init__(self, state_dim, action_dim, learning_rate=0.001, gamma=0.99, epsilon=1.0, epsilon_decay=0.996, min_epsilon=0.01, replay_buffer_size=10000, batch_size=64, target_update_freq=10):
